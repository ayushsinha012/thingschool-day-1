...
param apiAppName = 'quotes-api-day25-prod'
...
param sqlServerName = 'sql-quotesapi-day25-prod'
...
param serviceBusNamespaceName = 'sb-quotesapi-day25-prod'
...
param keyVaultName = 'kv-quotesapi-d25-prod'
...
// Set PROD_JWT_SIGNING_KEY (32+ chars) before deploying.
