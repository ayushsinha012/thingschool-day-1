...
public sealed class QuoteEventPublisher : IQuoteEventPublisher, IAsyncDisposable
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            message.ApplicationProperties[MessagingTelemetry.TraceParentProperty] = traceParent;

            if (activity.TraceStateString is { } traceState)
            {
                message.ApplicationProperties[MessagingTelemetry.TraceStateProperty] = traceState;
            }
        }
